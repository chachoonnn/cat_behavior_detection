...
class DataPrepare():
    ...
    def moveAnnotationDataTime(self, seconds):
        ...
        output_file = 'new_' + self.annotationFileName
        ...
        for row in reader:
            ...
            row['DataTime_s'] = str(float(row['DataTime_s']) + seconds)
            writer.writerow(row)
    ...
    def createWindowedData( self ):
        ...
        windowedDf = WindowSensorData(deviceDf, windowSizeSec=2.0, stepSizeSec=1.0)
